  ...
  return (
    <div className={`animate-[fadeIn_0.35s_ease-out] space-y-6 pb-32 lg:space-y-8 transition-opacity duration-500 ${loading ? 'opacity-60 pointer-events-none' : 'opacity-100'}`}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-6">
        ...
        {/* 1. Total Sales */}
        <div className={`${card} p-3 sm:p-5 lg:p-6 group flex flex-col justify-between col-span-1`}>
          <div className="flex items-start justify-between mb-1 sm:mb-2">
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
                <p className="text-[11px] sm:text-[13px] font-bold text-slate-500 dark:text-slate-400">ຍອດຂາຍລວມ</p>
              ...
              <p className="text-[17px] sm:text-3xl font-extrabold tabular-nums text-slate-900 dark:text-white leading-tight">
